...
RAW_PHOTOS_ALL_DIR = REPO_ROOT / "raw_photos_all"
PHOTOS_DIR = REPO_ROOT / "photos"
ALL_PHOTOS_DIR = REPO_ROOT / "all_photos"
BUILD_LOCK_PATH = REPO_ROOT / ".build.lock"
LOCAL_PHOTO_CACHE_ROOT = REPO_ROOT / ".photo_processing_cache"
PHOTO_PREVIEW_MAX_DIMENSION = 1400
EGOBLUR_DIR = REPO_ROOT / "egoblur"
EGOBLUR_MODELS_DIR = EGOBLUR_DIR / "models"
EGOBLUR_FACE_MODEL_PATH = EGOBLUR_MODELS_DIR / "ego_blur_face_gen2.jit"
EGOBLUR_LP_MODEL_PATH = EGOBLUR_MODELS_DIR / "ego_blur_lp_gen2.jit"
EGOBLUR_DOCKER_IMAGE = "egoblur"
EGOBLUR_COMMAND = "egoblur-gen2"
EGOBLUR_FACE_SCORE_THRESHOLD = 0.4
EGOBLUR_LP_SCORE_THRESHOLD = 0.5
